...
class Text:
    ...
    def draw(self):
        self.font.render_to(self.app.screen, (WIN_W * 0.625, WIN_H * 0.02), 
                            text = 'Tetris', fgcolor = 'green', size = TILE_SIZE * 2, bgcolor = 'black')
        self.font.render_to(self.app.screen, (WIN_W * 0.68, WIN_H * 0.22), 
                            text = 'next', fgcolor = 'orange', size = TILE_SIZE * 1.7, bgcolor = 'black')
        self.font.render_to(self.app.screen, (WIN_W * 0.65, WIN_H * 0.67), 
                            text = 'score', fgcolor = 'orange', size = TILE_SIZE * 1.7, bgcolor = 'black')
        self.font.render_to(self.app.screen, (WIN_W * 0.68, WIN_H * 0.8), 
                            text = f'{self.app.tetris.score}', fgcolor = 'green', size = TILE_SIZE * 2.18)
